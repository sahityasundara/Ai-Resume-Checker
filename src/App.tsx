    ...
    return (
        <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gray-950 selection:bg-indigo-500/30 font-inter">
            ...
            <div className="relative z-10 container mx-auto px-6 text-center max-w-6xl">
                ...
                {/* Hero Badge */}
                <div className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 rounded-full px-4 py-2 mb-8 backdrop-blur-md animate-fade-in hover:bg-white/10 transition-colors">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                    </span>
                    <span className="text-sm font-medium text-gray-300 tracking-wide">AI-Powered Resume Optimization</span>
                </div>

                {/* Hero Title */}
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter text-white mb-8 leading-tight drop-shadow-2xl animate-fade-in" style={{animationDelay: '0.1s'}}>
                    Land Your Dream <br />
                ...
                {/* Hero Subtitle */}
                <p className="text-lg md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed font-light animate-fade-in" style={{animationDelay: '0.2s'}}>
                    Don't let the ATS reject you. Get <span className="text-indigo-300 font-semibold">FAANG-level feedback</span>, match your resume to the job description, and prep for interviews with Gemini AI.
                </p>
